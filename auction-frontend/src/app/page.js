...
export default function HomePage() {
  const features = [
    ...
    {
      icon: <Zap className="text-red-800" size={24} />,
    ...
    {
      icon: <Trophy className="text-red-800" size={24} />,
      title: "Premium Items",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Discover Amazing
              <span className="block text-red-200">Auction Deals</span>
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
            ...
            <div className="text-center">
              ...
              <div className="text-red-200">Live Auctions</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold">$2M+</div>
              <div className="text-red-200">Items Sold</div>
            </div>
            <div className="text-center">
