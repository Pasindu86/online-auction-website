...
import { getCurrentUser, getOrder, processPayment } from '../../../lib/api';
...
export default function PaymentPage({ params }) {
  ...
  useEffect(() => {
    ...
    if (unwrappedParams?.orderId) {
      fetchOrderDetails(unwrappedParams.orderId);
    }
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="space-y-3">
            ...
            <Button variant="outline" onClick={() => router.push('/main/auctions')} className="w-full">
              Continue Shopping
            </Button>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <Button onClick={() => router.push('/main/auctions')}>Go Back to Auctions</Button>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">🎉 Congratulations! You won this auction! Complete your payment to receive your item.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow p-6 sticky top-8">
              ...
              {order && order.auction && (
                <div className="space-y-4">
                  {order.auction.imageUrl && (
                    <img 
                      src={order.auction.imageUrl} 
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 text-lg">{order.auction.title}</h3>
                    <p className="text-sm text-gray-600 mt-1 line-clamp-2">{order.auction.description}</p>
                  </div>
                  ...
                  <div className="bg-green-50 p-3 rounded-lg border border-green-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <span className="text-sm text-green-800 font-medium block">Secure Payment Protected</span>
                        <span className="text-xs text-green-700">Your transaction is safe and encrypted</span>
                      </div>
                    </div>
                  </div>
                </div>
